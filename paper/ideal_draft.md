...
Perhaps the most common public perception of politics is that it involves negative correlations in citizens’ preferences. Groups of citizens are viewed as struggling for power in a zerosum game, which implies negatively correlated preferences. Despite this common perception, most social interactions involve a mixture of both shared and conflicting interests. Even competitive and hostile interactions such as fist-fights, hockey games, bargaining, and warfare simultaneously involve shared interests and cooperative aspects [@shelling1960strategy]. Thus, political theorists should expect voters’ preferences to vary across different issues, likely encompassing the full range from negative to zero to positive correlations.
